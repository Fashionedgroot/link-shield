<?php
	...
	if(isset($_POST['pay'])){
		...
		$check=mysqli_query($conn,"UPDATE users SET pay_method='".$_POST['pay_method']."', details='".$_POST['details']."' WHERE user_id='".$_SESSION['user_id']."'");
		if($check){
			$alert='<div class="alert alert-success">Payment Settings Updated!</div>';
		} else {
			$alert='<div class="alert alert-danger">Payment Settings Updation Failed!</div>';
		}
}
...
<?php echo $alert;?>
                ...
                <div class="hk-pg-header">
					...
					<span class="feather-icon"><i data-feather="layers"></i></span></span>Payment Settings</h4>   
                </div>
                <!-- /Title -->
                <!-- Row -->
                <div class="row">
		...
		<form action="" method="post">
			 <fieldset>
					...
					<div class="form-group">
								<input type="submit" name="pay" class="btn btn-success" value="UPDATE"/></div>
			    	</fieldset>
